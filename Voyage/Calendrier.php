...
<div class="calendar">
  ...
  <div class="d-flex flex-row align-items-center justify-content-between">
    ...
    <div>
      <a href="calendrier.php?month=<?= $month->previousMonth()->month; ?>&year=<?= $month->previousMonth()->year; ?>" class="button">&lt;</a>
      <a href="calendrier.php?month=<?= $month->nextMonth()->month; ?>&year=<?= $month->nextMonth()->year; ?>" class="button">&gt;</a>
    </div>
  </div>
