            ...
            <table>
                <tr style="height: 100px;">
                    <td style="padding-right: 30px;">
                        ...
                        <input style="border: none; width: 220px; height: 27px; margin-top: 7px; padding-left: 5px; border-radius: 5px;" min="2022-04-16" step="7" type="date" name="date_debut"  required><br>
                    </td>

                    <td style="padding-left: 30px;">
                        <label for="date_fin">Au :</label><br>
                        <input style="border: none; width: 220px; height: 27px; margin-top: 7px; padding-left: 5px; border-radius: 5px;"min="2022-04-16" step="7" type="date" name="date_fin" required><br>
                    </td>
